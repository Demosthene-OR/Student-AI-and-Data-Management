...
import numpy as np
# import cv2
# Utilisation de PIL au lieu de cv2
			...
			def dense_anim(frame):
				...
				if(frame == 5):
					...
					if(True):
						...
						dense_labels['activation2'].visible = True
			...
			def conv_anim(frame):
				...
				if(frame == 7):
					...
					if(True):
						...
						conv_step_labels['concat'].visible = True
				...
				if(frame == 8):
					if(True):
						...
						if(True):
							...
							conv_step_labels['output'].visible = True
				...
				if(frame == 0):
					if(True):
						...
						if(True):
							...
							max_step_labels['input'].visible =True
					...
					if(True):                   
					   # Labels
						if(True):
							...
							max_step_labels['output'].visible = True
				...
				if(frame == 0):
					if(True):
						...
						if(True):
							...
							avg_step_labels['input'].visible = True
						...
						if(True):
							...
							for i in range(8):
								for j in range(8):
									...
									avg_input_1[8*i + j].opacities = [1]
									avg_input_1[8*i + j].visible = True
					return
				if(frame == 2):
					if(True):
						# Frame Return
					...
					if(True):                   
					   # Labels
						if(True):
							...
							avg_step_labels['output'].visible = True
			...
			def drop_anim(frame):
				...
				if(frame == 1):
					if(True):
						...
						if(True):
							...
							drop_labels['dotproduct1'].visible = False

							drop_labels['inputs'].default_opacities = [0.9]
							drop_labels['inputs'].visible = True
				...
				if(frame == 3):
					if(True):
						...
						if(True):
							...
							drop_labels['activation1'].visible = False
							drop_labels['dotproduct1'].default_opacities = [0]
							drop_labels['dotproduct1'].opacity = [0]
							drop_labels['dotproduct1'].visible = False
							...
							drop_labels['dropout1'].visible = True  
				...
				if(frame == 4):
					if(True):
						...
						if(True):
							...
							drop_labels['activation1'].visible = True
				...
				if(frame == 6):
					if(True):
						...
						if(True):
							...
							drop_labels['activation2'].visible = False
							drop_labels['dotproduct2'].default_opacities = [0]
							drop_labels['dotproduct2'].opacity = [0]
							drop_labels['dotproduct2'].visible = False

							drop_labels['dropout2'].default_opacities = [0.9]
							drop_labels['dropout2'].opacity = [0.9]   
							drop_labels['dropout2'].visible = True 
				...
				if(frame == 7):
					...
					if(True):
						...
						drop_labels['activation2'].visible = True
				...
				if(frame == 1):
					if(True):
						...
						if(True):
							...
							convprod_step_labels['multiply'].visible = True
